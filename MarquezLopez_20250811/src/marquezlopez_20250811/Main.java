...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // SE ASIGNA EL VALOR DE DÍAS A LA VARIABLE
        int dias = calcularDias (segundosTotales);
        // SE ASIGNA EL VALOR DE LOS SEGUNDOS EXCEDENTES O RESTANTES DESPUÉS DE HABER CALCULADO LOS DÍAS
        ...
        // LOS SEGUNDOS QUE QUEDAN DESPUÉS DE HABER REALIZADO TODOS LOS CÁCULOS ANTERIORES
    ...
    // MÓDULO PARA CALCULAR LOS SEGUNDOS RESTANTES DESPUÉS DE EXTRAER LOS DÍAS
    ...
    // MÓDULO PARA CALCULAR LOS SEGUNDOS RESTANTES DESPUÉS DE EXTRAER LAS HORAS
